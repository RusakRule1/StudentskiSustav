...
public class Stilovi {
    ...
    public static final String RAZMAK_VELIKI = "razmak-veliki";

    public static final String PADDING_MALI = "padding-mali";
    public static final String PADDING_SREDNJI = "padding-srednji";
    ...
    public static final String KONTEJNER_FORME = "kontejner-forme";
    public static final String SADRZAJ_SCROLL = "sadrzaj-scroll";

    public static final String RAZMAK_KONTROLE = "razmak-kontrole";
    public static final String RAZMAK_FORMA = "razmak-forma";
    public static final String RAZMAK_TABLICE = "razmak-tablice";
    public static final String RAZMAK_GUMBI = "razmak-gumbi";
    public static final String RAZMAK_RADIO = "razmak-radio";
    public static final String RAZMAK_AKCIJE = "razmak-akcije";
    public static final String RAZMAK_UNOS = "razmak-unos";
    ...
    public static final String GUMB_SIRINA_SREDNJA = "gumb-sirina-srednja";
    public static final String GUMB_SIRINA_MALA = "gumb-sirina-mala";
    ...
    public static final String MREZA_FORMA = "mreza-forma";

    public static final String PORUKA_GRESKA = "poruka-greska";
    public static final String PORUKA_USPJESNO = "poruka-uspjesno";

    public static final String TABLICA_VISINA_VELIKA = "tablica-visina-velika";
    public static final String TABLICA_VISINA_SREDNJA = "tablica-visina-srednja";
